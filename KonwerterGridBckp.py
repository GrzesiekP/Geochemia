...
class Konwerter(Tk):
    ...
    def initialize(self):
        ...
        buttonOpenInputFile=Button(self, text=u"Wskaz plik raportu", 
                                   command = self.OpenFile_in, height = 1, width = 22)
    ...
    #FUNKCJE
    def InstrukcjeClick(self):
        instrukcje = main_c.full_message
        showinfo("Instrukcje", instrukcje)

    def OpenFile_in(self):
    ...
    def IsEmpty(self, string, in_out):
        if string == "":
    ...
    def Run(self):
        ...
        self.IsEmpty(in_filepath, "pliku raportu")
        self.IsEmpty(out_filepath, "pliku wyjsciowego")
